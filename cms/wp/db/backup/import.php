...
task(
    ...
    static function (): void {
        ...
        runLocally('cd {{app_path}} && wp db import ../{{local_database_backups}}/' . $latestBackup);
        runLocally('cd {{app_path}} && wp cache flush');  // Have to do this locally
        runLocally('cd {{app_path}} && wp rewrite flush');
